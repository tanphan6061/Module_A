...
@section('content')
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        ...
        <form method="post" class="needs-validation" novalidate action="{{route('rooms.store',$event)}}">
            ...
            <div class="row">
                <div class="col-12 col-lg-4 mb-3">
                    ...
                    <select class="form-control {{$errors->has('channel_id')?'is-invalid':''}}" id="selectChannel"
                            name="channel_id">
